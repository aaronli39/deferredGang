...
var acceptance_bar = function(colleges){
    /*
     * Provides a bar chart on data of the selected college in reference to other selected colleges.
     */
    var url_choice = "https://api.datausa.io/api/?sort=desc&show=university&required=applicants_total%2Cadmissions_total&sumlevel=all&year=all";
    d3.json(url_choice).then(function(data) {
      var array = data['data'];
